      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              ...
              <div className="text-center">
                {/* Number */}
                <div className="inline-flex items-center justify-center w-24 h-24 rounded-2xl bg-gradient-to-br from-accent/10 to-primary/10 border border-border mb-6">
        ...
        <div className="text-center">
          <Link
            ...
            className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-accent to-primary px-8 py-4 text-base font-semibold text-white hover:opacity-90 transition-all shadow-lg shadow-primary/25"
          >
