      ...
      <div className="relative w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="text-center w-full overflow-hidden">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight mb-6 max-w-5xl mx-auto leading-tight text-balance">
            <span className="text-foreground">Pomáhame e-shopom predávať viac pomocou </span>
            <span className="bg-gradient-to-r from-accent via-primary to-[#9b4dca] bg-clip-text text-transparent">AI obsahu</span>
            <span className="text-foreground"> a </span>
            <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Meta reklám</span>
          </h1>

          {/* Subheadline */}
          <p className="mx-auto max-w-2xl text-base sm:text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed text-balance">
            Komplexný systém - stratégia, kreatíva aj funnel. Všetko musia hráť dokopy.
          </p>
          ...
          <p className="text-sm text-muted-foreground mb-16 text-balance">
            Bez zmlúvy. Bez skrytých poplatkov. Len výsledky.
          </p>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground mt-1">Vygenerované výnosy</p>
            </div>
            <div className="text-center">
              <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-white">
                <AnimatedCounter end={10500} duration={2000} suffix="+" />
              </p>
              <p className="text-xs sm:text-sm text-muted-foreground mt-1">Vedení obchody</p>
            </div>
            <div className="text-center">
              <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-white">
                <AnimatedCounter end={20} duration={1500} suffix="+" />
              </p>
              <p className="text-xs sm:text-sm text-muted-foreground mt-1">Spokojní klienti</p>
            </div>
            <div className="text-center">
              <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-white">
                <AnimatedCounter end={12} duration={1500} suffix="+" />
              </p>
              <p className="text-xs sm:text-sm text-muted-foreground mt-1">Rokov skúsenosti</p>
            </div>
          </div>

          {/* Video Section - SLOVAK VIDEO ONLY */}
          <div 
            ref={videoRef}
            ...
            <div className="relative rounded-2xl overflow-hidden border border-border shadow-2xl shadow-primary/10">
              <div className="relative w-full overflow-hidden" style={{ paddingBottom: '56.25%' }}>
                <iframe 
                  ...
                  title="Dolphin Wave Media - Výsledky video"
                  loading="lazy"
                />
              </div>
            </div>
