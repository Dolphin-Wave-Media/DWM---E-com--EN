      ...
      <div className="relative w-full mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="text-center w-full overflow-hidden">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight mb-6 max-w-5xl mx-auto leading-tight text-balance">
            <span className="text-foreground">Help your e-shop sell more with </span>
            <span className="bg-gradient-to-r from-accent via-primary to-[#9b4dca] bg-clip-text text-transparent">AI-powered content</span>
            <span className="text-foreground"> and </span>
            <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Meta advertising</span>
          </h1>

          {/* Subheadline */}
          <p className="mx-auto max-w-2xl text-base sm:text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed text-balance">
            A complete system: strategy, creative, and funnel design. Everything must work together.
          </p>
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-xs sm:text-sm text-muted-foreground mt-1">Leads Delivered</p>
            </div>
            <div className="text-center">
              <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-white">
          ...
          {/* Video Section - ENGLISH VIDEO ONLY */}
          <div 
            ref={videoRef}
